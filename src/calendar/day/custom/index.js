...
class Day extends Component {
  ...
  onPressAppointment = () => {
    this.props.pressAppointment(this.props.date);
  };

  onPressAvailable = time => {
    this.props.pressAvailable(time, this.props.date);
  };
  ...
  render() {
    ...
    let type =
        marking.customStyles != undefined &&
        marking.customStyles.type != undefined
    ...
    return (
      ...
      >
        <TouchableOpacity
          ...
          onPress={
            (type != undefined && type == 'available') || type == 'appointment'
              ? type == 'appointment'
                ? this.onPressAppointment
                : () => {
          ...
          disabled={
            type != undefined && type == 'unavailable'
              ? true
